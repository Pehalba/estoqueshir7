...
const ALBA_FEDEX_03_ITEMS = [
  ...
  { orderId: '#1156', size: 'XG', sizeLabel: 'XGG (XXL)', name: 'Democracia', number: '13' },
  ...
  { orderId: '#1180', size: 'XG', sizeLabel: 'XGG (XXL)', name: 'Nina', number: '04' },
  ...
  { orderId: '#1199', size: 'XG', sizeLabel: 'XGG (XXL)', name: 'BECH', number: '26' },
